...
// class SHSExport implements FromCollection
// {
//     /**
...
//     {
//         return Proses_shs::all();
//     }
// }

class SHSExport implements FromArray, WithHeadings
{
    public function array(): array
    {
        $data = Proses_shs::all(); // Mengambil semua data
