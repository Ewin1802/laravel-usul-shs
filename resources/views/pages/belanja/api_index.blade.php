                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{ route('belanjaApi.index') }}">
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('belanjaApi.edit', $bel->id) }}" class="btn btn-sm btn-info btn-icon ml-2" style="min-width: 100px; height: 40px;">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <!-- Tombol Delete -->
                                                    <form action="{{ route('belanjaApi.hapus', $bel->id) }}" method="POST" >
                                                        @csrf
                                                        @method('DELETE')

                                                        <button class="btn btn-sm btn-danger btn-icon ml-2" style="min-width: 100px; height: 40px;"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="importForm" action="{{ route('belanjaApi.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="file">Upload Excel File</label>
                        <input type="file" name="file" class="form-control" required>
