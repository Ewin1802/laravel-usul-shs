...
@section('title', 'Usulan HSPK SKPD')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Usulan Harga Satuan Pokok Kegiatan (HSPK)</h1>
                <div class="section-header-button">
                    <a href="{{ route('hspk.create') }}"
                        class="btn btn-primary">Buat Usulan Baru</a>
                </div>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Akses SKPD</a></div>
                    {{-- <div class="breadcrumb-item"><a href="#">Usulan</a></div> --}}
                    <div class="breadcrumb-item">Usulan Harga Satuan Pokok Kegiatan</div>
                </div>
            </div>
            @if(session('error'))
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Usulan Harga Satuan Pokok Kegiatan</h4>
                            </div>
                            <div class="card-body">
                                <div class="float-left">
                                    <form method="GET" action="{{ route('hspk.index') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a href='{{ route('hspk_user.edit', $s->id) }}'
