...
@section('title', 'Usulan HSPK - ADMIN')
...
@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Proses Usulan Harga Satuan Pokok Kegiatan (HSPK)</h1>
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Proses Usulan Harga Satuan Pokok Kegiatan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <p class="section-lead">
                    Anda dapat mengelola semua Usulan Harga Satuan Pokok Kegiatan, seperti mengedit, menghapus, dan lainnya.
                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Daftar Usulan Harga Satuan Pokok Kegiatan</h4>
                            </div>
                            <div class="card-body">
                                <div class="float-left">
                                    <form method="GET" action="{{ route('hspk.admin_hspk') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a href='{{ route('hspk_admin.edit', $s->id) }}'
                                                    ...
                                                    <a href='#'
                                                        ...
                                                        data-url="{{ route('hspk.verified', $s->id) }}">
                                                    ...
                                                    <a href='#'
                                                        ...
                                                        data-url="{{ route('hspk.tolak', $s->id) }}">
                                                        <i class="fas fa-hand-paper"></i> <!-- Ikon times (x) -->
                                                        Tolak
                                                    </a>

                                                    <form action="{{ route('hspk.hapus', $s->id) }}" method="POST" class="ml-2">
                                                        @csrf
                                ...
                                <div class="float-right">
                                    {{ $admin_hspk->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="yearModal" tabindex="-1" role="dialog" aria-labelledby="yearModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="yearForm" action="{{ url('/hspk/generate-pdf') }}" method="GET" target="_blank">
