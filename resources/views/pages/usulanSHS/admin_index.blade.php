...
@section('title', 'Usulan SHS - ADMIN')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Proses Usulan Standar Harga Satuan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <p class="section-lead">
                    Anda dapat mengelola semua Usulan Standar Harga Satuan, seperti mengedit, menghapus, dan lainnya.
                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Daftar Usulan Standar Harga Satuan</h4>
                            </div>
                            <div class="card-body">
                                <div class="float-left">
                                    <form method="GET" action="{{ route('shs.admin_shs') }}" class="row g-2 mb-3">
                                ...
                                {{-- <div class="float-right">
                                    <form method="GET" action="{{route('shs.admin_shs')}}">
                                ...
                                <div class="float-right">
                                    {{ $admin_shs->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (modalAlasan) {
                modalAlasan.addEventListener('show.bs.modal', function(event) {
                    ...
                    document.getElementById('alasan_id').value = id;
                    document.getElementById('alasan_text').value = alasan;

                    console.log('EDIT ALASAN ID:', id);
                });
            }
