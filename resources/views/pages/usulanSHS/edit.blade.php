        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Usulan SSH</a></div>
                    <div class="breadcrumb-item">Edit Usulan SSH</div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('shs_user.ubah', $usulan->id) }}" method="POST">
                        @csrf
