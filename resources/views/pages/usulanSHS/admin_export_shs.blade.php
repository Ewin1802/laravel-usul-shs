        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    Anda dapat mengeksport seluruh Usulan SSH saat ini dari SKPD menjadi file Excell dan di import pada SIPD-RI.
                </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{route('shs.export_shs')}}">
                                ...
                                <div class="float-right">
                                    {{ $export_shs->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.getElementById('export-link').addEventListener('click', function() {
            fetch("{{ route('shs.export') }}")
                ...
                .then(blob => {
                    ...
                    let fileName = formattedDate + '_export_shs.xlsx';
