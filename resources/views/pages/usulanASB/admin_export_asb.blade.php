    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Export Usulan Analisis Standar Belanja</h1>

                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Akses Admin</a></div>
                    <div class="breadcrumb-item"><a href="#">Export</a></div>
                    <div class="breadcrumb-item">Export Usulan Analisis Standar Belanja</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <p class="section-lead">
                    Anda dapat mengeksport seluruh Usulan ASB saat ini dari SKPD menjadi file Excell dan di import pada SIPD-RI.
                </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{route('asb.export_asb')}}">
                                ...
                                <div class="float-right">
                                    {{ $export_asb->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.getElementById('export-link').addEventListener('click', function() {
            fetch("{{ route('asb.export') }}")
                ...
                .then(blob => {
                    ...
                    let fileName = formattedDate + '_export_asb.xlsx';
