    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Usulan Analisis Standar Belanja</h1>
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Usulan Analisis Standar Belanja</div>
                </div>
            </div>
            @if(session('error'))
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Usulan Analisis Standar Belanja</h4>
                            </div>
                            <div class="card-body">
                                <div class="float-left">
                                    <form method="GET" action="{{ route('asb.index') }}">
