        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Usulan Standar Biaya Umum</div>
                </div>
            </div>
            @if(session('error'))
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Usulan Standar Biaya Umum</h4>
                            </div>
                            <div class="card-body">
                                <div class="float-left">
                                    <form method="GET" action="{{ route('sbu.index') }}">
